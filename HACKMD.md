...
這週在 EMBA 課堂上，老師提到了 OpenClaw 專案，許多非理工背景的同學顯出高度興趣。OpenClaw 被稱為「個人版的 Jarvis」，可以像一個私人秘書那樣——傳訊息給它，它就幫你查資料、整理信件、提醒你開會。
...
2. 用 Google 帳號登入
3. 點左邊的「Get API Key」
![螢幕擷取畫面 2026-03-22 152150](https://hackmd.io/_uploads/H1pBbXTqZx.png)
4. 點「Create API Key」
![螢幕擷取畫面 2026-03-22 155934](https://hackmd.io/_uploads/SytumQT9-x.png)
...
![IMG_6245[1]](https://hackmd.io/_uploads/HJYdSQpcWe.png)
